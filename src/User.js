    ...
    const formik = useFormik({
        ...
        onSubmit:(values,{resetForm})=>{
            ...
            console.log(firstName,key);
             axios.post('https://bulkmailapp.onrender.com/register',{firstName,lastName,email,key})
    ...
    <div className='initial' >
        ...
        <div className="useCase"  onClick={()=>setDemo(!demo)}>
                ...
                {demo?<div className='demo'>
                    For ADD new account enter the two step verification code from the google account  in the key input box
